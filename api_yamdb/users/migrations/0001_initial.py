    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[users.validators.validate_pattern_symbols])),
                ('email', models.EmailField(max_length=254, unique=True, validators=[users.validators.max_length])),
